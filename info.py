...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001943196163').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', "-1001943196163")
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1001967167299')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1001967167299')
...
if HAS_SSL:
    URL = "https://sakuna-by-purplebotz-mrblackgod.koyeb.app/".format(FQDN)
else:
    URL = "https://sakuna-by-purplebotz-mrblackgod.koyeb.app/".format(FQDN)
